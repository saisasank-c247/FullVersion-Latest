...
import { addUser } from "src/pages/apps/createpage/CreatePageService.js";
            ...
            <Card square >
              <CardContent>
                ...
                {(!show) ? <Box style={{ marginTop: "5px" }}>
                  ...
                  <ReactQuill theme="snow" value={editorimg} onChange={(e) => handleEditorChange(e)} />
                </Box> :
                  <Grid item xs={12} lg={12} md={12} sm={12}>
                    <div style={{ marginTop: "11px" }}>
                      ...
                      {/* {formik.values.shortdescription ?  <DoneIcon style={{position: "absolute", left: "814px",top: "130px",color:"green"}}/>:
                                        <ErrorOutlineRoundedIcon style={{position: "absolute", left: "814px",top: "130px",color:"red"}}/>} */}
                    </div>
