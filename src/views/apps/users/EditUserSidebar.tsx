...
import { EditEventSidebarType } from 'src/types/apps/imagegeneratorTypes'
...
export const EditUserSidebar = (props: EditEventSidebarType) => {
    const {
        drawerWidth,
...
console.log(editValue,"editValue");
    ...
    const formik = useFormik({
        ...
        onSubmit: (values: any) => {
            console.log(values,"values  of editUser");
            setShowError(false)
            dataGet(values)
            // addUser(values)
            resetToEmptyValues()
    ...
    useEffect(() => {
        if (editValue) {
            formik.setFieldValue("id", editValue.id);
            formik.setFieldValue("name", editValue.name);
            formik.setFieldValue("email", editValue.email);

            console.log(formik.values,"vaklues");
